...
void main() {
  ...
  double managerCalculatedSalary =
      manager.calculateSalary(managerBaseSalary, 1000.0);
  double developerBaseSalary = developer.getBaseSalary();
  double developerCalculatedSalary =
      developer.calculateSalary(developerBaseSalary, 500.0);
